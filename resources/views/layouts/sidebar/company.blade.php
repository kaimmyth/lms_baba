...
<li><a href="{{url(Session::get('redirect_url').'/instructor/dashboard')}}"> <i class="metismenu-icon pe-7s-id"></i>Instructor Dashboard</a></li>
<li><a href="{{url(Session::get('redirect_url').'/instructor')}}"> <i class="metismenu-icon pe-7s-id"></i>Instructor</a></li>
<li><a href="#"><i class="metismenu-icon pe-7s-diamond"></i>Manage Course<i class="metismenu-state-icon pe-7s-angle-down caret-left"></i></a>
    <ul>
        <li><a href="{{url(Session::get('redirect_url').'/instructor/manage/course')}}"><i class="metismenu-icon"></i>Training Material</a></li>
        <li><a href="{{url(Session::get('redirect_url').'/instructor/manage/learning_plan')}}"><i class="metismenu-icon"></i>New Learning Plan</a></li>
        <li><a href="{{url(Session::get('redirect_url').'/instructor/manage/course_catelog')}}"><i class="metismenu-icon"></i>Course Catelogue</a></li>                          
    </ul>
</li>
<li>
    <a href="#">
    ...
    <ul>
        <li><a href="{{url(Session::get('redirect_url').'/instructor/learning-object/reference-material')}}"><i class="metismenu-icon"></i>Manage Course Management</a></li>
        <li><a href="{{url(Session::get('redirect_url').'/instructor/learning-object/manage-video')}}"><i class="metismenu-icon"></i>Manage Video</a></li>
        <li><a href="{{url(Session::get('redirect_url').'/instructor/learning-object/manage-mcq')}}"><i class="metismenu-icon"></i>Manage MCQ</a></li>
    </ul>
</li>

<li><a href="{{url(Session::get('redirect_url').'/instructor/quizz')}}"><i class="metismenu-icon pe-7s-way"></i>Quizz</a></li>
<li><a href="{{url(Session::get('redirect_url').'/instructor/test-series')}}"><i class="metismenu-icon pe-7s-id"></i>Test Series</a></li>
<li><a href="{{url(Session::get('redirect_url').'/instructor/course-report')}}"><i class="metismenu-icon pe-7s-way"></i>Course Report</a></li>
<li><a href="{{url(Session::get('redirect_url').'/instructor/create-certificate')}}"><i class="metismenu-icon pe-7s-way"></i>Certificate</a></li>
...
<li><a href="{{url(Session::get('redirect_url').'/learner')}}"><i class="metismenu-icon pe-7s-way"></i>Laerner</a></li>
