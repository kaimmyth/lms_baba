            ...
            <div class="mb-3 card">
                <div class="card-header-tab card-header">
                    ...
                    <div class="card-header-title font-size-lg text-capitalize font-weight-normal">
                        ...
                        <strong>Shivani Shrivastava</strong>
                    </div>
                ...
                <div class="no-gutters row">
                    <div class="col-sm-6 col-md-4 col-xl-4">
                        <div class="card no-shadow rm-border bg-transparent widget-chart text-left">
                            ...
                            <div class="widget-chart-content">
                                <div class="widget-subheading">Subscription Date</div>
                                <div class="widget-numbers">15 jan 2020</div>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6 col-md-4 col-xl-4">
                        <div class="card no-shadow rm-border bg-transparent widget-chart text-left">
                            ...
                            <div class="widget-chart-content">
                                <div class="widget-subheading">Last Access Date & Time</div>
                                <div class="widget-numbers"><span>01/01/2020 | 12:06:00 PM</span></div>
                    ...
                    <div class="col-sm-12 col-md-4 col-xl-4">
                        <div class="card no-shadow rm-border bg-transparent widget-chart text-left">
                            ...
                            <div class="widget-chart-content">
                                ...
                                <div class="widget-numbers text-success"><span>05</span></div>
        ...
        <div class="row">
                ...
                <div class="mb-3 card">
                    <div class="card-header-tab card-header">
                        ...
                        <div class="btn-actions-pane-right">
                            <div class="nav">
                                <a href="#tab-eg-55" data-toggle="tab" class="border-0 btn-pill btn-wide btn-transition active btn btn-outline-alternate">Progress</a>
                                <a href="#tab-eg-66" data-toggle="tab" class="ml-1 btn-pill btn-wide border-0 btn-transition  btn btn-outline-alternate second-tab-toggle-alt">My Performance</a>
                            </div>
                        </div>
                    </div>
                    <div class="tab-content">
                        <div class="tab-pane fade active show" id="tab-eg-55">
                            ...
                            <div class="pt-2" style="padding: 1em;">
                                <div class="row">
                                    <div class="col-md-6">
            ...
            <div class="col-md-12 col-lg-6 col-xl-5">
                <div class="mb-3 card">
                    ...
                    <div class="p-0" style="padding: 1em;">
                ...
                <div class="card mb-3 widget-content bg-premium-dark">
                    <div class="widget-content-wrapper text-white">
                        <div class="widget-content-left">
                            <div class="widget-heading">Most 1 Top Pouplar Courses</div>
                            <div class="widget-subheading">Computer</div>
                        </div>
                        <div class="widget-content-right">
