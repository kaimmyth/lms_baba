        ...
        <div class="row">
            <div class="col-md-12">
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        <form action="{{url(('/'.Auth::user()->name.'/company/setting/tool-master/course-category/add'))}}" method="post" enctype="text/multipart"> 
                            @csrf
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-8">
                                                <div class="position-relative form-group">
                                                    ...
                                                    <input name="categoryname" id="categoryname" placeholder="" type="text" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="position-relative form-group">
                                                    <label for="exampleSelect" class="">Select status</label>
                                                    <select name="categoryStatus" id="exampleSelect" class="form-control" required>
