    ...
    <div class="app-main__inner">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        <form action="{{url(('/'.Auth::user()->name.'/company/instructor/add'))}}" method="post" enctype="text/multipart"> 
                            @csrf
                                ...
                                <ul class="forms-wizard nav nav-tabs step-anchor">
                                    <li class="nav-item active">
                                        <a href="#step-1" class="nav-link">
                                            <em>1</em><span>Instructor Detail</span>
                                        </a>
                                    </li>
                                </ul>
        ...
        <div class="card-body">
            <table class="mb-0 table table-sm">
                ...
                <tbody>
                    @if($instructorList)
                    @foreach($instructorList as $key=>$value)
                    <tr>
                        <td>{{++$key}}</td>
                        <td>{{$value->name}}</td>
